...
import './UserIcon.css'; // Import the CSS file

const UserIcon = () => {
  return (
    <div className="icon-container">
      <svg className="icon" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
